...
int main() {
    ...
    // Parameters: input begin, input end, output begin, operator.
    // _1 stands for the elements of first input vector(dvec_x here).
    ...
    // use(instantiate) function object SqrtOf() here instead of sqrt() function.
